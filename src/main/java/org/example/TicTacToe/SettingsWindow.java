...
public class SettingsWindow extends JFrame {
    ...
    JLabel gameField = new JLabel("Размер поля:");
    JLabel winCount = new JLabel("Длина в ряд для победы:");
    ...
    SettingsWindow(GameWindow gameWindow) {
        ...
        fieldSlider.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                gameField.setText("Размер поля: " + fieldSlider.getValue());
            }
        });
        winLengthSlider.addChangeListener(new ChangeListener() {
            @Override
            public void stateChanged(ChangeEvent e) {
                winCount.setText("Длина для победы: " + winLengthSlider.getValue());
            }
        });
